...
public class RoomLightingControl : MonoBehaviour
{
    ...
    public bool enterTheEmptyBossRoom = false;
    ...
    public void ChangeGameStateForTest(GameManager gameManager )
    {
    ...
    private void StaticEventHandler_OnRoomChanged(RoomChangedEventArgs roomChangedEventArgs)
    {
        ...
        if (roomChangedEventArgs.room == instantiatedRoom.room && !instantiatedRoom.room.isLit)
        {
            ...
            if(roomChangedEventArgs.room.roomNodeType.isBossRoom == true)
            {
                Debug.Log("enter boss room");
                enterTheEmptyBossRoom = true;
